...
export const authorPhoto = place => (place.profile_photo_url ? place.profile_photo_url : 'http://dummyimage.com/100x100/666/ffffff&text=No+Image');
            ...
            <div class="row">
               <div class="col-sm-3">
                 <div class="review__title">
                    <img src="${authorPhoto(review)}" class="img-rounded" alt="${review.author_name}">
                    <div class="review__name"><a href="#">${review.author_name}</a></div>
                 </div>
               </div>
               <div class="col-sm-9">
                 <div class="review__details">
                   <div class="review__rate star__rating">${restaurantRating(review)}</div>
                   <div class="review__description">${review.text}</div>
                 </div>
               </div>
            </div>
            <hr/>
